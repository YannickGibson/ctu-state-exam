...
function parseTable(file, group) {
...
const raw = [...parseTable('SPOL.md', 'SPOL'), ...parseTable('ZI.md', 'ZI')];
const subjectCounts = {};
...
console.log(`progress.json: ${Object.keys(progress).length} entries`);
...
console.log(`answers/: ${answerStubs} stub file(s) created`);
...
console.log(`quizzes/: ${quizStubs} stub file(s) created (${subjects.length} subjects)`);
